...
const METHOD = "POST";
const ROUTE_PATH = "/api/v1/channels.rename";
const TOOL_KEY = "pos-api-v1-channels.rename";
...
export async function pos_api_v1_channels_rename(args = {}, context = {}) {
  const {
...
export default pos_api_v1_channels_rename;
