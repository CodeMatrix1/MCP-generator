...
const METHOD = "POST";
const ROUTE_PATH = "/api/v1/channels.removeOwner";
const TOOL_KEY = "post-api-v1-channels.removeOwner";
...
export async function post_api_v1_channels_removeowner(args = {}, context = {}) {
  const {
...
export default post_api_v1_channels_removeowner;
