...
const METHOD = "POST";
const ROUTE_PATH = "/api/v1/channels.removeModerator";
const TOOL_KEY = "post-api-v1-channels.removeModerator";
...
export async function post_api_v1_channels_removemoderator(args = {}, context = {}) {
  const {
...
export default post_api_v1_channels_removemoderator;
