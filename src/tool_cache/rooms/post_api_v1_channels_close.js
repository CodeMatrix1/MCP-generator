...
const METHOD = "POST";
const ROUTE_PATH = "/api/v1/channels.close";
const TOOL_KEY = "post-api-v1-channels.close";
...
export async function post_api_v1_channels_close(args = {}, context = {}) {
  const {
...
export default post_api_v1_channels_close;
