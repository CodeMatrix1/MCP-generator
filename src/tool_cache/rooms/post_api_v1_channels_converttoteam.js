...
const METHOD = "POST";
const ROUTE_PATH = "/api/v1/channels.convertToTeam";
const TOOL_KEY = "post-api-v1-channels.convertToTeam";
...
export async function post_api_v1_channels_converttoteam(args = {}, context = {}) {
  const {
...
export default post_api_v1_channels_converttoteam;
