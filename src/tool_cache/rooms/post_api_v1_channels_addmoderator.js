...
const METHOD = "POST";
const ROUTE_PATH = "/api/v1/channels.addModerator";
const TOOL_KEY = "post-api-v1-channels.addModerator";
...
export async function post_api_v1_channels_addmoderator(args = {}, context = {}) {
  const {
...
export default post_api_v1_channels_addmoderator;
