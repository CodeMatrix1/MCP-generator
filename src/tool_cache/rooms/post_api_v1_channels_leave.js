...
const METHOD = "POST";
const ROUTE_PATH = "/api/v1/channels.leave";
const TOOL_KEY = "post-api-v1-channels.leave";
...
export async function post_api_v1_channels_leave(args = {}, context = {}) {
  const {
...
export default post_api_v1_channels_leave;
