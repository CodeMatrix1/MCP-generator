...
const METHOD = "POST";
const ROUTE_PATH = "/api/v1/channels.addOwner";
const TOOL_KEY = "post-api-v1-channels.addOwner";
...
export async function post_api_v1_channels_addowner(args = {}, context = {}) {
  const {
...
export default post_api_v1_channels_addowner;
