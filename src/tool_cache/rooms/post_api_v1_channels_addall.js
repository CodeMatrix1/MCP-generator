...
const METHOD = "POST";
const ROUTE_PATH = "/api/v1/channels.addAll";
const TOOL_KEY = "post-api-v1-channels.addAll";
...
export async function post_api_v1_channels_addall(args = {}, context = {}) {
  const {
...
export default post_api_v1_channels_addall;
