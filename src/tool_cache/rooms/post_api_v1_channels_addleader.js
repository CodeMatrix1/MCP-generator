...
const METHOD = "POST";
const ROUTE_PATH = "/api/v1/channels.addLeader";
const TOOL_KEY = "post-api-v1-channels.addLeader";
...
export const meta = {
  ...
  "requestSchema": {
    ...
    "properties": {
      ...
      "userId": {
        "type": "string",
        "description": "The ID of the user to be made leader."
      }
    },
    "required": [
      "roomId",
...
export async function post_api_v1_channels_addleader(args = {}, context = {}) {
  const {
...
export default post_api_v1_channels_addleader;
