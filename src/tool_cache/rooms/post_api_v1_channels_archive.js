...
const METHOD = "POST";
const ROUTE_PATH = "/api/v1/channels.archive";
const TOOL_KEY = "post-api-v1-channels.archive";
...
export async function post_api_v1_channels_archive(args = {}, context = {}) {
  const {
...
export default post_api_v1_channels_archive;
