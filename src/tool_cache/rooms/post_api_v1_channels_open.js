...
const METHOD = "POST";
const ROUTE_PATH = "/api/v1/channels.open";
const TOOL_KEY = "post-api-v1-channels.open";
...
export async function post_api_v1_channels_open(args = {}, context = {}) {
  const {
...
export default post_api_v1_channels_open;
