...
const METHOD = "POST";
const ROUTE_PATH = "/api/v1/channels.delete";
const TOOL_KEY = "post-api-v1-channels.delete";
...
export async function post_api_v1_channels_delete(args = {}, context = {}) {
  const {
...
export default post_api_v1_channels_delete;
