...
const METHOD = "GET";
const ROUTE_PATH = "/api/v1/dm.list";
const TOOL_KEY = "get-api-v1-im.list";
...
export async function get_api_v1_im_list(args = {}, context = {}) {
  const {
...
export default get_api_v1_im_list;
