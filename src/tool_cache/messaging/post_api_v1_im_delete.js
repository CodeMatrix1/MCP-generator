...
const METHOD = "POST";
const ROUTE_PATH = "/api/v1/dm.delete";
const TOOL_KEY = "post-api-v1-im.delete";
...
export async function post_api_v1_im_delete(args = {}, context = {}) {
  const {
...
export default post_api_v1_im_delete;
